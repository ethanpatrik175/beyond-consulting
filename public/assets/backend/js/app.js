! function (e) {
    ...
    function o(t) {
        1 == e("#light-mode-switch").prop("checked") && "light-mode-switch" === t ? (e("html").removeAttr("dir"), e("#dark-mode-switch").prop("checked", !1), e("#rtl-mode-switch").prop("checked", !1), e("#dark-rtl-mode-switch").prop("checked", !1), e("#bootstrap-style").attr("href", siteOrigin + "/backend/css/bootstrap.min.css"), e("#app-style").attr("href", siteOrigin + "/backend/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == e("#dark-mode-switch").prop("checked") && "dark-mode-switch" === t ? (e("html").removeAttr("dir"), e("#light-mode-switch").prop("checked", !1), e("#rtl-mode-switch").prop("checked", !1), e("#dark-rtl-mode-switch").prop("checked", !1), e("#bootstrap-style").attr("href", siteOrigin + "/backend/css/bootstrap-dark.min.css"), e("#app-style").attr("href", siteOrigin + "/backend/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == e("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === t ? (e("#light-mode-switch").prop("checked", !1), e("#dark-mode-switch").prop("checked", !1), e("#dark-rtl-mode-switch").prop("checked", !1), e("#bootstrap-style").attr("href", siteOrigin + "/backend/css/bootstrap-rtl.min.css"), e("#app-style").attr("href", siteOrigin + "/backend/css/app-rtl.min.css"), e("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch")) : 1 == e("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === t && (e("#light-mode-switch").prop("checked", !1), e("#rtl-mode-switch").prop("checked", !1), e("#dark-mode-switch").prop("checked", !1), e("#bootstrap-style").attr("href", siteOrigin + "/backend/css/bootstrap-dark-rtl.min.css"), e("#app-style").attr("href", siteOrigin + "/backend/css/app-dark-rtl.min.css"), e("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"))
    }
