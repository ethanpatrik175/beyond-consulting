                ...
                <div class="row mt-4 mt-md-0">
                    <div class="col-lg-7 offset-lg-5">
                        <div class="work-box text-center">
                            ...
                            <p class="mt-2">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odio
                                esse necessitatibu. Odio esse necessitatibu.</p>
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="work-box text-center">
                            ...
                            <p class="mt-2 text-white">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Odio
                                esse necessitatibu. Odio esse necessitatibu.</p>
                        </div>
                    </div>
