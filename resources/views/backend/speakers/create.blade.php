    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="needs-validation create-form" method="POST" action="{{ route('speakers.store') }}" enctype="multipart/form-data" novalidate>
                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name"
                                                    placeholder="Speaker Name" value="{{ old('name') }}" required>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control" name="twitter" id="twitter"
                                                    placeholder="Twitter Account" value="{{ old('twitter') }}" />
                                            </div>
                                        </div>
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
