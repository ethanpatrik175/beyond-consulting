...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form class="needs-validation" method="POST" action="{{route('comments.store')}}" enctype="multipart/form-data"
                novalidate>
                <div class="row">
                    @csrf
                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea rows="4" class="form-control" name="comment" id="comment"
                                                placeholder="Description here" required>{{old('comment')}}</textarea>
