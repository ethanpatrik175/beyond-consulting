...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form class="needs-validation" method="POST" action="{{route('product_metas.store')}}"
                ...
                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="key" id="key"
                                                placeholder="Key" value="{{old('key')}}" required />
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea rows="4" class="form-control" name="content" id="content"
                                                placeholder="Content here" required>{{ old('content') }}</textarea>
                                            <div class="invalid-feedback">
                    ...
                    <div class="col-sm-12 mb-5">
                        <button type="submit" class="btn btn-primary">Add Product Meta</button>
                    </div>
                </div>
            </form>
        </div>
