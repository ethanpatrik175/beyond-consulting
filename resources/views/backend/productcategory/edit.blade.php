...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form class="needs-validation" method="POST" action="{{route('product_categories.update', $Category->id)}}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="Title" id="title"
                                                placeholder="Title" value="{{$Category->title ?? ''}}" required
                                                onkeyup="myFunction();">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <select  name="parent_id"
                                                ...
                                                <option value="">Select Parents Category</option>
                                                @foreach($parents as $repo)
                                                <option value="{{$repo->id}}" {{ ($Category->parent_id == $repo->id) ? 'selected' : '' }} >{{$repo->title}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <img src="{{asset('assets/frontend/images/productcategory/'.$Category->icon)}}"
