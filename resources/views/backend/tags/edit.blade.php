    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="needs-validation" method="POST" action="{{ route('tags.update', $service->id) }}"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="slug" id="slug"
                                                    placeholder="Slug" value="{{ $service->slug ?? '' }}" required>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('assets/frontend/images/tags/' . $service->icon) }}"
