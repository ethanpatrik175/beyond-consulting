    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form class="needs-validation create-form" method="POST" action="{{ route('events.update', $event->id) }}" enctype="multipart/form-data" novalidate>
                    <div class="row">
                        <div class="col-sm-10 mb-2">
                            {!! $buttons !!}
                        </div>
                        <div class="col-sm-2 text-end"><button type="submit" class="btn btn-sm btn-primary">UPDATE {{ strtoupper(Str::singular($section)) }}</button></div>
                    </div>
                    <div class="row">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="sub_title" id="sub_title"
                                                    placeholder="Sub Title" value="{{ $event->sub_title ?? '' }}" />
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="slug" id="slug"
                                                    placeholder="Slug" value="{{ $event->slug ?? '' }}" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea rows="2" class="form-control" name="summary" id="summary"
                                                    placeholder="Event Summary" required>{{ ($event->summary) ? json_decode($event->summary) : '' }}</textarea>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="description" id="description" placeholder="Description here"
                                                    required>{!! ($event->description) ? json_decode($event->description) : '' !!}</textarea>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" min="0" class="form-control" name="day_number" id="day_number" placeholder="Day Number" value="{{ $event->day_number ?? '' }}" required/>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="venue_id" id="venue_id" aria-placeholder="Select Venue" required>
                                                    ...
                                                    @foreach($venues as $venue)
                                                        <option value="{{ $venue->id }}" {{ ($event->venue_id) ? ( ($event->venue_id == $venue->id) ? 'selected' : '' ) : '' }}>{{ $venue->title ?? '' }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="speaker_id" id="speaker_id" aria-placeholder="Select Speaker" required>
                                                    ...
                                                    @foreach($speakers as $speaker)
                                                        <option value="{{ $speaker->id }}" {{ ($event->speaker_id) ? ( ($event->speaker_id == $speaker->id) ? 'selected' : '' ) : '' }}>{{ $speaker->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" class="form-control" name="start_at" id="start_at" value="{{ $event->start_at ?? '' }}" required/>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-mask text-start" name="orig_price" id="orig_price" value="{{ json_decode($event->metadata)->orig_price ?? '' }}" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'" required/>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control input-mask text-start" name="price" id="price" value="{{ json_decode($event->metadata)->price ?? '' }}" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'digits': 2, 'digitsOptional': false, 'placeholder': '0'" required/>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-3">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <img src="{{ asset('assets/frontend/images/events/' . Str::of($event->image)->replace(' ', '%20')) }}" class="form-control img-thumbnail mh-400" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
